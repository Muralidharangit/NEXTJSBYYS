                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="relative space-y-8 md:space-y-0">
                        ...
                        >
                            ...
                            <div className="w-full md:w-1/2 text-white md:pr-6">
                                ...
                                <div data-aos="fade-right" data-aos-duration="1500">
                                    ...
                                    <ul className="mb-5 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
                                        ...
                                        <li className="flex items-center gap-x-2 " data-aos="fade-right" data-aos-delay="200">
                                            {/* SVG and Span content remains */}
                                        </li>
                                        <li className="flex items-center gap-x-2" data-aos="fade-right" data-aos-delay="300">
                                            {/* SVG and Span content remains */}
                                        </li>
                                        <li className="flex items-center gap-x-2 " data-aos="fade-right" data-aos-delay="400">
                                            {/* SVG and Span content remains */}
                                        </li>
                                    </ul>
                                    <ul className="flex flex-wrap gap-2">
                                        {/* Buttons can have a final little zoom-in */}
                                        <li className="px-3 py-1 border border-white rounded-full text-white" data-aos="zoom-in" data-aos-delay="500">
                                            More Details
                                        </li>
                                        <li className="px-3 py-1 border border-white rounded-full text-white" data-aos="zoom-in" data-aos-delay="600">
                                            Contact us
                                        </li>
                                    </ul>
                                </div>
                            ...
                            {/* Image */}
                            <div className="w-full md:w-1/2 mt-6 md:mt-0" data-aos="fade-left" data-aos-duration="1500">
                                <img
                        ...
                        >
                            {/* Image */}
                            <div className="w-full md:w-1/2 mt-6 md:mt-0 md:pr-6" data-aos="fade-right" data-aos-duration="1500">
                                <img
                            ...
                            <div className="w-full md:w-1/2 text-white md:pl-6">
                                <div data-aos="fade-left" data-aos-duration="1500">
                                    ...
                                    <ul className="mb-5 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
                                        <li className="flex items-center gap-x-2 " data-aos="fade-left" data-aos-delay="200">
                                            {/* SVG and Span content remains */}
                                        </li>
                                        <li className="flex items-center gap-x-2" data-aos="fade-left" data-aos-delay="300">
                                            {/* SVG and Span content remains */}
                                        </li>
                                        <li className="flex items-center gap-x-2 " data-aos="fade-left" data-aos-delay="400">
                                            {/* SVG and Span content remains */}
                                        </li>
                                    </ul>
                                    <ul className="flex flex-wrap gap-2">
