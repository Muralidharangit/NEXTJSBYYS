  ...
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "IND001",
        details:
          "type: conveyor system, length: 10m, material: stainless steel",
      ...
      },
      {
        ...
        materialCode: "FAB002",
        details:
          "material: mild steel, dimensions: custom, finish: powder coated",
        category: "Metal Fabrication",
      },
    ],
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "FST006",
        details:
          "size: M8, material: stainless steel, type: butterfly wing nut",
        category: "Nuts",
      },
    ],
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "HCH003",
        details:
          "blade: retractable, length: 6 inches, material: stainless steel",
      ...
      },
      {
        ...
        materialCode: "HCH004",
        details:
          "blade length: 18 inches, material: high-carbon steel, teeth per inch: 7",
        category: "Saws",
      },
      {
        image:
  ...
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "HPN002",
        details:
          "displacement: 16 cc/rev, max pressure: 3000 PSI, material: aluminum",
  ...
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "ITS003",
        details:
          "type: membrane, connectivity: wireless, battery life: 12 months",
        category: "Keyboards",
      },
      {
        image:
    ...
    product: [
      {
        ...
        materialCode: "LAB001",
        details:
          "material: borosilicate glass, capacity: 500ml, tolerance: ±5%",
        category: "Glassware",
      },
      {
        image:
      ...
      },
      {
        ...
        materialCode: "LAB006",
        details:
          "material: polypropylene, capacity: 50 tubes, type: autoclavable",
        category: "Glassware",
      },
    ],
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "LGT002",
        details:
          "length: 4 feet, power: 18W, color temperature: 4000K (Natural White)",
      ...
      },
      {
        ...
        materialCode: "LGT006",
        details:
          "power: 10W, smart control: Wi-Fi enabled, color changing: RGB",
        category: "LED Bulbs",
      },
    ],
  },
...

  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "ACS001",
        details:
          "type: fingerprint, capacity: 500 users, communication: TCP/IP",
  ...
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "TMI003",
        details:
          "range: 0-100 psi, dial size: 2.5 inches, connection: 1/4 inch NPT",
  ...
  },
  {
    ...
    product: [
      ...
      },
      {
        ...
        materialCode: "WEL003",
        details:
          "viewing area: 100x50mm, response time: 1/10000 sec, adjustable shade",
    ...
    product: [
      {
        ...
        materialCode: "WM001",
        details:
          "wire diameter: 2.5mm, mesh size: 50x50mm, sheet size: 4ft x 8ft",
      ...
      },
      {
        ...
        materialCode: "WM005",
        details:
          "wire diameter: 1.2mm, mesh size: 10x10mm, material: stainless steel",
      ...
      <section className="relative py-20  overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div data-aos="fade-up" className="max-w-4xl mx-auto mb-12">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-semibold text-[#050d20] leading-tight">
              Integrating India’s Hardware Ecosystem
            </h2>

            <p className="mt-4 text-gray-700 leading-relaxed">
              Byyizzy connects suppliers, manufacturers, and local hardware
              stores to build a transparent, scalable network that drives
              industrial growth.
            </p>
          </div>
          ...
          >
            {[
              {
                title: "Fastest Industrial Delivery",
                desc: "Ensuring on-time, in-full delivery with optimized inventory and local fulfillment centers.",
                icon: "🚚",
                // gradient: "from-[#067afe]/10 to-[#00c6ff]/20",
              },
              {
                title: "Easy Credit & EMI",
                desc: "Flexible payment and credit options designed for hardware suppliers and businesses.",
                icon: "💳",
                // gradient: "from-[#00c6ff]/10 to-[#067afe]/20",
              },
              {
                title: "Smart Inventory Model",
                desc: "AI-driven demand forecasting reduces dead stock and improves profit margins.",
                icon: "📦",
                // gradient: "from-[#067afe]/10 to-[#00c6ff]/20",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className={`relative group p-8 rounded-2xl border border-white/40 bg-gradient-to-br ${feature.gradient} backdrop-blur-md shadow-[0_8px_20px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_rgba(6,122,254,0.3)] transition-all duration-500 hover:-translate-y-1`}
              >
