  ...
  return (
    <>
      <Head>
        ...
        {/* The meta description tag goes here */}
        <meta
          name="description"
          content="A brief summary for search enginwefwfewfwefes."
        />
      </Head>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              >
                ...
                delivery, we simplify complex industrial supply chains and
          ...
          <div className="py-20">
            <div className="container mx-auto px-4">
              ...
              <div className="relative space-y-12 md:space-y-16">
                {/* Product 1 - Content Left, Image Right (PaaS) */}
                <div
                  className={`sticky top-32 ${ACCESSIBLE_BLUE} rounded-xl p-2 md:p-8 md:flex md:items-center mb-3`}
                >
                    ...
                    <ul className="mb-6 space-y-4">
                      {[
                        ...
                        <li className="flex items-center gap-x-2" key={index}>
                          {" "}
                          {/* KEY FIX: Using index as key */}
                          <span className="flex h-7 w-7 justify-center items-center rounded-full bg-white">
                            <svg
                              stroke="#0057b3" // SVG color changed to match background for consistency, though original #067afe is fine on white
                              fill="#0057b3"
                              strokeWidth={0}
                              viewBox="0 0 512 512"
                              className="h-4 w-4"
              ...
              but these two are static and not in a map loop, so they don't need a key. */}
                ...
                {/* Product 2 - Image Left, Content Right (Hardware Store Chain) */}
                <div
                ...
                {/* Product 3 - Content Left, Image Right (MaaS) */}
                <div
                  className={`sticky top-32 ${ACCESSIBLE_BLUE} rounded-xl p-8 md:flex md:items-center mb-3`}
                >
                  {" "}
                ...
                <div
                  className={`sticky top-32 ${ACCESSIBLE_BLUE} rounded-xl p-8 md:flex md:items-center`}
                >
                  {" "}
                  {/* CONTRAST FIX APPLIED */}
                  <div className="w-full md:w-1/2 md:pr-6">
                  ...
                  <div className="w-full md:w-1/2 text-white md:pl-6">
                    ...
                    <p className="mb-6">
                      Streamline your procurement. Create value. Generate
            ...
            >
              ...
              <div className="flex justify-center">
                <p
                  ...
                  data-aos-delay="400"
                >
                  We take pride in collaborating with industry-leading clients
