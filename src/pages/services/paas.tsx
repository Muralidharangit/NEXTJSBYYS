                ...
                <div className="py-[50px] md:py-[60px] lg:py-[80px] xl:py-[100px]">
                    <div className="container mx-auto">
                        ...
                        <div className="max-w-5xl mx-auto text-center mb-16 p-10">
                            ...
                            >
                                A fully managed, tech-driven procurement model with complete transparency and measurable savings.
                                Our global sourcing expertise, local fulfillment network, and AI-powered digital ecosystem ensure
                                faster sourcing, lower costs, and smoother operations — all in one integrated platform.
                            </p>
                                ...
                                {[
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 4h18v12H3V4zm3 16h12m-9-4h6" />
                                            </svg>
                                        ),
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6h4m-2 0v12m6-9h2m-16 0h2m12 6h2m-16 0h2" />
                                            </svg>
                                        ),
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h3v8H5v-8zm5-4h3v12h-3V8zm5 6h3v6h-3v-6z" />
                                            </svg>
                                        ),
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 0c3 2.5 3 7.5 0 10-3-2.5-3-7.5 0-10zm-7 5h14m-14 10h14" />
                                            </svg>
                                        ),
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 2C8 3 6 8 6 8l4 2-2 4 4 2s5-2 6-6-2-8-6-8z" />
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M5 19l2-2m0 0l3-1-1 3-2 2m0-4L3 17l2 2z" />
                                            </svg>
                                        ),
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 7h18M3 11h18m-9 6h9a2 2 0 002-2V7a2 2 0 00-2-2H3a2 2 0 00-2 2v8a2 2 0 002 2h9z" />
                                            </svg>
                                        ),
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M4 19V9m4 10V5m4 14v-7m4 7V8m4 11V3" />
                                            </svg>
                                        ),
                                    },
                                ].map((feature, index) => (
                                    ...
                                    <div key={feature.title} data-aos="fade-up" data-aos-delay={index * 100}>
                                        ...
                                        >
                                            ...
                                            {/* CONTENT */}
                                            <h4 className="text-lg font-semibold text-[#050d20] mb-2 group-hover:text-[#067afe] transition-colors duration-300">{feature.title}</h4>
